...
INSERT INTO `data_node` VALUES ('main','center','center'),('local','center','center');
...
INSERT INTO `key` VALUES (1,'0jevljhlspujvmix'),(1,'0qaxzn7vhe3act4t'),(2,'0qaxzn7vhe3act4t');
...
CREATE TABLE `online` (
  ...
  `socket` int(10) unsigned NOT NULL COMMENT '套接字',
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `quest` VALUES (1,1,1,'[{quest_progress,event_kill_monster,3,gt}]',0,'');
