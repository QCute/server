...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='搭讪配置表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='激活码配置';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='激活码奖励配置';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `data_node` (
  ...
  `server_ip` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '游戏服IP(string)',
  ...
  `center_ip` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '中央服IP(string)'
...
LOCK TABLES `data_node` WRITE;
/*!40000 ALTER TABLE `data_node` DISABLE KEYS */;
INSERT INTO `data_node` VALUES ('main',0,'','center',0,''),('local',0,'','center',0,''),('test',0,'','center',0,'');
/*!40000 ALTER TABLE `data_node` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `data_parameter` (
  `key` varchar(100) NOT NULL DEFAULT '' COMMENT '参数键',
  `value` varchar(1000) NOT NULL DEFAULT '' COMMENT '参数值',
  `description` varchar(200) NOT NULL DEFAULT '' COMMENT '参数名称(string)',
  PRIMARY KEY (`key`) USING BTREE
...
INSERT INTO `data_parameter` VALUES ('null','',''),('test','',''),('{guild_create, 1}','[{level, 10}, {vip, 0}, {gold, 0}]','一级'),('{guild_create, 2}','[{level, 10}, {vip, 1}, {gold, 100}]','二级'),('{guild_create, cd}','86400','创建/加入冷却时间');
/*!40000 ALTER TABLE `data_parameter` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `data_quest`
--
...
CREATE TABLE `data_quest` (
  ...
  `condition` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '条件',
  `progress` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '目标',
  `award` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '奖励',
...
--
-- Dumping data for table `data_quest`
--

LOCK TABLES `data_quest` WRITE;
/*!40000 ALTER TABLE `data_quest` DISABLE KEYS */;
INSERT INTO `data_quest` VALUES (1,1,0,2,'[]','[{quest_progress, event_kill_monster, 3, gt}]','[{1,100}]'),(2,1,1,3,'[{copper, 100}]','[{quest_progress, event_level_upgrade, 10, gt}]','[{1,100}]'),(3,1,2,0,'[{level, 10}]','[{quest_progress, event_dungeon, 5, gt}]','[{1,100}]');
...
CREATE TABLE `data_text` (
  `key` varchar(100) NOT NULL DEFAULT '' COMMENT '参数键',
  `value` varchar(1000) NOT NULL DEFAULT '' COMMENT '参数值(string)',
  `description` varchar(200) NOT NULL DEFAULT '' COMMENT '描述(string)',
  PRIMARY KEY (`key`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='游戏文本配置表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `data_text` WRITE;
/*!40000 ALTER TABLE `data_text` DISABLE KEYS */;
INSERT INTO `data_text` VALUES ('1','不用买，随便爆','成龙台词'),('2','是兄弟就来砍我','古天乐台词'),('3','卸载掉手机那个假传奇','甄子丹台词'),('test','','');
/*!40000 ALTER TABLE `data_text` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `data_vip` VALUES (1,6),(2,30),(3,100),(4,150),(5,300),(6,600),(7,1000),(8,2000),(9,3000),(10,5000),(11,10000),(12,30000),(13,60000),(14,100000),(15,200000);
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `key` (
  `player_id` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT 'ID',
  `key` varchar(24) NOT NULL DEFAULT '' COMMENT '码',
  PRIMARY KEY (`player_id`,`key`) USING BTREE,
  KEY `key` (`key`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='激活码';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `quest` (
  `player_id` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '玩家ID(select)',
  `quest_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '任务ID',
  `group_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '组ID',
  `progress` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '进度(convert)',
  `award` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '是否领取奖励',
  `extra` varchar(0) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '额外(ignore)(flag)',
  PRIMARY KEY (`player_id`,`quest_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='任务表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='排行';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user` (
  ...
  `store` varchar(0) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '仓库背包(convert)',
  `quest` varchar(0) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '任务表(convert)',
  `mail` varchar(0) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '邮件表(convert)',
...
-- Dump completed on 2019-03-23 13:58:54
