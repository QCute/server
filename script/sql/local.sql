...
INSERT INTO `buff_data` VALUES (1,1,0,'[9]',0,1,'铜币',''),(2,2,3600,'[10]',0,2,'经验',''),(3,3,120,'[9]',0,3,'经验',''),(4,4,0,'[10]',0,2,'经验',''),(5,5,0,'[10]',0,1,'经验',''),(6,6,0,'[9]',0,0,'铜币',''),(7,7,0,'',0,0,'','');
...
INSERT INTO `effect_data` VALUES (1,'active','battle','','10000','_','add','self','hurt','','Hurt',0,'','伤害'),(2,'active','battle','','10000','_','add','self','hurt','','Hurt * 1.5',0,'','增加50%伤害'),(3,'active','battle','SelfAttribute.hp == 0','10000','_','add','self','attribute','hp','Self.Attribute.health',0,'','死亡立即复活'),(4,'active','battle','','10000','_','set','self','attribute','vertigo','0',0,'','清除眩晕'),(5,'active','battle','','10000','_','reduce','self','attribute','hp','Rival.Attribute.health * 0.01',3600,'','每秒扣血，总血量百分之1'),(6,'active','battle','','10000','_','add','mate','attribute','attack','Mate.Attribute.attack * 1.5',3,'','增加队友攻击150%'),(7,'active','battle','','10000','_','add','mate','attribute','defense','Mate.Attribute.defense * 1.5',3,'','增加队友防御150%'),(8,'active','battle','','10000','_','add','self','buff','','[1]',0,'','添加Buff'),(9,'active','user','','10000','_','add','self','asset','copper','1.5',0,'','增加150%铜币'),(10,'active','user','','10000','_','add','self','asset','exp','2',0,'','增加200%经验');
...
INSERT INTO `map_data` VALUES (100000,'slice','false','','role','hurt','share','','','','',''),(100001,'full','false','[1]','guild','hurt','share','','','','',''),(100002,'full','false','[2]','team','hurt','share','','','','',''),(100003,'full','false','','camp','hurt','share','','','','',''),(200001,'full','false','','role','hurt','share','','','','',''),(200002,'full','false','','guild','hurt','share','','','','',''),(200003,'full','false','','team','hurt','share','','','','',''),(200004,'slice','true','','camp','hurt','share','','','','','');
...
CREATE TABLE `online_log` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `time` (`time`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1001000000000434 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPRESSED COMMENT='在线统计日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `role` VALUES (1001000001,'1',1001,'1',1,0,1,1,100,100,100,1,1596353111,1593741101,0,'test','{map,1000010000000001,100001,<0.120.0>,undefined,66,40}','','web.','','192.168.1.76');
...
INSERT INTO `sign` VALUES (1001000001,6,0,0);
...
-- Dump completed on 2020-08-02 20:50:31
