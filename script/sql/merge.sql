...
INSERT INTO {{dst}}.`charge` (`charge_no`,`charge_id`,`order_id`,`channel`,`role_id`,`role_name`,`money`,`status`,`time`) SELECT `charge_no`,`charge_id`,`order_id`,`channel`,`role_id`,`role_name`,`money`,`status`,`time` FROM {{src}}.`charge`;
INSERT INTO {{dst}}.`role` (`role_id`,`role_name`,`server_id`,`account_name`,`origin_server_id`,`type`,`status`,`sex`,`avatar`,`classes`,`level`,`is_online`,`register_time`,`login_time`,`logout_time`,`first_charge_time`,`last_charge_time`,`charge_total`,`item_size`,`bag_size`,`store_size`,`map`,`channel`,`device_id`,`device_type`,`mac`,`ip`) SELECT `role_id`,`role_name`,`server_id`,`account_name`,`origin_server_id`,`type`,`status`,`sex`,`avatar`,`classes`,`level`,`is_online`,`register_time`,`login_time`,`logout_time`,`first_charge_time`,`last_charge_time`,`charge_total`,`item_size`,`bag_size`,`store_size`,`map`,`channel`,`device_id`,`device_type`,`mac`,`ip` FROM {{src}}.`role`;
