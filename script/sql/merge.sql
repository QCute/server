...
INSERT INTO {{dst}}.`recharge` (`recharge_no`,`recharge_id`,`order_id`,`channel`,`role_id`,`role_name`,`server_id`,`account`,`money`,`status`,`time`) SELECT `recharge_no`,`recharge_id`,`order_id`,`channel`,`role_id`,`role_name`,`server_id`,`account`,`money`,`status`,`time` FROM {{src}}.`recharge`;
