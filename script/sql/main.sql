...
CREATE TABLE `activity_data`  (
  ...
  `service` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '服务进程模块(validate(activity_service))',
  ...
  `name` char(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '活动名',
  `icon` char(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '活动图标',
  `entrance` char(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '活动入口',
  `description` char(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '活动描述',
  PRIMARY KEY (`activity_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '活动配置表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `auction`  (
  ...
  `from` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '物品来源',
  ...
  `seller_list` varchar(0) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '卖家列表(default([]))',
  `bidder_list` varchar(0) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '买家列表(default([]))',
  `guild_id` bigint(20) UNSIGNED NOT NULL DEFAULT 0 COMMENT '公会ID',
  `timer` varchar(0) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '定时器',
...
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '拍卖信息表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '拍卖配置表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `auction_log`  (
  ...
  `role_name` char(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '获得者名字',
  `server_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '获得者服ID',
  `time` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `role_id`(`role_id`) USING BTREE,
  INDEX `time`(`time`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '拍卖日志表' ROW_FORMAT = Compressed;
...
CREATE TABLE `auction_role`  (
  ...
  `role_name` char(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '出价者名字',
  `guild_id` int(20) UNSIGNED NOT NULL DEFAULT 0 COMMENT '出价者公会ID',
  `guild_name` char(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '出价者公会名字',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '拍卖角色表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '角色计数表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `dungeon`  (
  ...
  `flag` varchar(0) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '标识(flag)',
  PRIMARY KEY (`role_id`, `type`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '角色副本表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `dungeon_data`  (
  ...
  `cost` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '消耗',
  `day_number` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '每日次数',
  `buy_number` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '购买次数',
  ...
  `monsters` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '怪物',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '副本配置表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `effect_data`  (
  ...
  `type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '类型(validate(effect_type))',
  `scope` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '作用范围(validate(effect_scope))',
  `condition` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '条件',
  `ratio` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '概率',
  `restrict` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '约束',
  `operation` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '操作(validate(effect_operation))',
  `object` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '作用对象(validate(effect_object))',
  `attribute` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '操作属性(validate(effect_attribute))',
  `field` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '操作属性字段(validate(effect_field))',
  `value` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '属性值',
  `time` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '效果时间',
  `extra` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '额外',
  `description` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '描述',
  PRIMARY KEY (`effect_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '作用效果配置表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '角色好友表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `guild`  (
  ...
  `leader_name` char(0) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '会长名字(join(`role`.`role_name`))',
  `leader_sex` varchar(0) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '性别(join(`role`.`sex`)/default(0))',
  `leader_class` varchar(0) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '会长名字(join(`role`.`classes`))',
  `leader_level` varchar(0) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '职业(join(`role`.`level`)/default(0))',
  `leader_vip_level` varchar(0) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '会长名字(join(`vip`.`vip_level`))',
  `flag` varchar(0) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '标识(flag)',
...
-- Records of guild
-- ----------------------------
INSERT INTO `guild` VALUES (1, 1, 100, 1, 1577808000, '1', '1', 1, '', '', '', '', '', '');
INSERT INTO `guild` VALUES (2, 2, 200, 2, 1577894400, '2', '2', 2, '', '', '', '', '', '');
INSERT INTO `guild` VALUES (3, 3, 300, 3, 1577980800, '3', '3', 3, '', '', '', '', '', '');
...
CREATE TABLE `guild_apply`  (
  ...
  `level` varchar(0) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '职业(join(`role`.`level`)/default(0))',
  `vip_level` varchar(0) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT 'VIP等级(join(`vip`.`vip_level`)/default(0))',
  `flag` varchar(0) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '标识(flag)',
...
-- ----------------------------
INSERT INTO `guild_apply` VALUES (1, 7, 1578326400, '', '', '', '', '', '', '');
INSERT INTO `guild_apply` VALUES (1, 8, 1578412800, '', '', '', '', '', '', '');
INSERT INTO `guild_apply` VALUES (2, 9, 1578499200, '', '', '', '', '', '', '');
INSERT INTO `guild_apply` VALUES (3, 10, 1578585600, '', '', '', '', '', '', '');
...
-- ----------------------------
INSERT INTO `guild_role` VALUES (1, 1, 1, 100, 1577808000, 0, '', '', '', '', '', '', '');
INSERT INTO `guild_role` VALUES (2, 2, 1, 200, 1577894400, 0, '', '', '', '', '', '', '');
INSERT INTO `guild_role` VALUES (3, 3, 1, 300, 1577980800, 0, '', '', '', '', '', '', '');
INSERT INTO `guild_role` VALUES (1, 4, 2, 400, 1578067200, 0, '', '', '', '', '', '', '');
INSERT INTO `guild_role` VALUES (1, 5, 5, 500, 1578153600, 0, '', '', '', '', '', '', '');
INSERT INTO `guild_role` VALUES (2, 6, 2, 600, 1578240000, 0, '', '', '', '', '', '', '');
...
CREATE TABLE `increment`  (
  `name` char(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0' COMMENT '名字',
...
CREATE TABLE `item`  (
  ...
  INDEX `role_id`(`role_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 28 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '角色物品表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `item_consume_log`  (
  ...
  INDEX `role_id`(`role_id`) USING BTREE,
  INDEX `time`(`time`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '物品消费日志表' ROW_FORMAT = Compressed;
...
CREATE TABLE `item_produce_log`  (
  ...
  INDEX `role_id`(`role_id`) USING BTREE,
  INDEX `time`(`time`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '物品产出日志表' ROW_FORMAT = Compressed;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '角色兑换码表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `key_award_data`  (
  `type` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '类型',
  `unique` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '是否唯一(validate(boolean))',
  `award` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '奖励',
  PRIMARY KEY (`type`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '兑换码奖励配置表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `key_data`  (
  `key` char(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '码',
  `type` tinyint(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '类型',
  PRIMARY KEY (`key`) USING BTREE,
  INDEX `key`(`key`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '兑换码配置表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `login_log`  (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `role_id` bigint(20) UNSIGNED NOT NULL DEFAULT 0 COMMENT '角色ID',
  `ip` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '登录IP',
  ...
  INDEX `role_id`(`role_id`) USING BTREE,
  INDEX `time`(`time`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '登录日志' ROW_FORMAT = Compressed;
...
CREATE TABLE `lucky_money`  (
  ...
  `server_id` smallint(5) UNSIGNED NOT NULL DEFAULT 0 COMMENT '服务器ID',
  `role_id` bigint(20) UNSIGNED NOT NULL DEFAULT 0 COMMENT '角色ID',
  `role_name` char(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '角色名',
  `guild_id` bigint(20) UNSIGNED NOT NULL DEFAULT 0 COMMENT '公会ID',
  `guild_name` char(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '公会名',
  ...
  `receive_list` varchar(0) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '领取列表',
  `time` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '发送时间',
  `flag` varchar(0) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '标识(flag)',
  PRIMARY KEY (`lucky_money_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '红包信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `lucky_money_role`  (
  ...
  `flag` varchar(0) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '标识(flag)',
  PRIMARY KEY (`lucky_money_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '红包角色表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `mail`  (
  ...
  `sender_nick` char(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '发送者昵称',
  `receiver_id` bigint(20) UNSIGNED NOT NULL DEFAULT 0 COMMENT '接收者(select)',
  `receiver_nick` char(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '接受者昵称',
...
CREATE TABLE `map_data`  (
  `map_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '地图ID',
  `type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '广播类型(validate(map_type))',
  `reconnect` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '是否重连(validate(boolean))',
  `monsters` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '随地图启动的怪物',
  `rank_key` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '榜键类型(validate(map_rank_key))',
  `rank_value` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '榜值类型(validate(map_rank_value))',
  `rank_mode` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '榜模式(validate(map_rank_mode))',
  `enter_points` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '进入点',
  `pk_mode` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT 'PK模式',
  `enter_script` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '进入脚本',
  `relive_script` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '复活脚本',
  `leave_script` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '离开脚本',
...
CREATE TABLE `monster_data`  (
  ...
  `name` char(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '怪物名称',
  `description` char(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '怪物描述',
  ...
  `act_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '动作类型(validate(act_type))',
  `act_script` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '动作脚本(enemy:敌人/role:玩家/monster:怪物/{monster,组ID}:特定怪物)',
  `skills` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '技能',
  `born_points` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '出生点',
  `award` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '奖励',
...
CREATE TABLE `online_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `time`(`time`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 158 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '在线统计日志' ROW_FORMAT = Compressed;

-- ----------------------------
-- Records of online_log
-- ----------------------------
INSERT INTO `online_log` VALUES (1, 0, 0, 0, 17, 1586598694);
INSERT INTO `online_log` VALUES (2, 1, 0, 0, 18, 1586600361);
INSERT INTO `online_log` VALUES (3, 1, 0, 0, 18, 1586600421);
INSERT INTO `online_log` VALUES (4, 1, 0, 0, 18, 1586600481);
INSERT INTO `online_log` VALUES (5, 1, 0, 0, 18, 1586600541);
INSERT INTO `online_log` VALUES (6, 1, 0, 0, 18, 1586600601);
INSERT INTO `online_log` VALUES (7, 1, 0, 0, 18, 1586600661);
INSERT INTO `online_log` VALUES (8, 1, 0, 0, 18, 1586600721);
INSERT INTO `online_log` VALUES (9, 1, 0, 0, 18, 1586600782);
INSERT INTO `online_log` VALUES (10, 1, 0, 0, 18, 1586600842);
INSERT INTO `online_log` VALUES (11, 1, 0, 0, 18, 1586600902);
INSERT INTO `online_log` VALUES (12, 1, 0, 0, 18, 1586600962);
INSERT INTO `online_log` VALUES (13, 1, 0, 0, 18, 1586601022);
INSERT INTO `online_log` VALUES (14, 1, 0, 0, 18, 1586601082);
INSERT INTO `online_log` VALUES (15, 1, 0, 0, 18, 1586601142);
INSERT INTO `online_log` VALUES (16, 1, 0, 0, 18, 1586601273);
INSERT INTO `online_log` VALUES (17, 1, 0, 0, 18, 1586601333);
INSERT INTO `online_log` VALUES (18, 1, 0, 0, 18, 1586601393);
INSERT INTO `online_log` VALUES (19, 1, 0, 0, 18, 1586601453);
INSERT INTO `online_log` VALUES (20, 1, 0, 0, 18, 1586601513);
INSERT INTO `online_log` VALUES (21, 1, 0, 0, 18, 1586601573);
INSERT INTO `online_log` VALUES (22, 1, 0, 0, 18, 1586601633);
INSERT INTO `online_log` VALUES (23, 1, 0, 0, 18, 1586601693);
INSERT INTO `online_log` VALUES (24, 1, 0, 0, 18, 1586601753);
INSERT INTO `online_log` VALUES (25, 1, 0, 0, 18, 1586601813);
INSERT INTO `online_log` VALUES (26, 1, 0, 0, 18, 1586601873);
INSERT INTO `online_log` VALUES (27, 1, 0, 0, 18, 1586601933);
INSERT INTO `online_log` VALUES (28, 0, 0, 0, 10, 1587089644);
INSERT INTO `online_log` VALUES (29, 0, 0, 0, 10, 1587089704);
INSERT INTO `online_log` VALUES (30, 0, 0, 0, 10, 1587089764);
INSERT INTO `online_log` VALUES (31, 0, 0, 0, 10, 1587089824);
INSERT INTO `online_log` VALUES (32, 0, 0, 0, 10, 1587089884);
INSERT INTO `online_log` VALUES (33, 0, 0, 0, 10, 1587089944);
INSERT INTO `online_log` VALUES (34, 0, 0, 0, 10, 1587090004);
INSERT INTO `online_log` VALUES (35, 0, 0, 0, 10, 1587090064);
INSERT INTO `online_log` VALUES (36, 0, 0, 0, 10, 1587090124);
INSERT INTO `online_log` VALUES (37, 0, 0, 0, 10, 1587090184);
INSERT INTO `online_log` VALUES (38, 0, 0, 0, 10, 1587090244);
INSERT INTO `online_log` VALUES (39, 0, 0, 0, 10, 1587090304);
INSERT INTO `online_log` VALUES (40, 0, 0, 0, 10, 1587090364);
INSERT INTO `online_log` VALUES (41, 0, 0, 0, 10, 1587090424);
INSERT INTO `online_log` VALUES (42, 0, 0, 0, 10, 1587090484);
INSERT INTO `online_log` VALUES (43, 0, 0, 0, 10, 1587090544);
INSERT INTO `online_log` VALUES (44, 0, 0, 0, 10, 1587090604);
INSERT INTO `online_log` VALUES (45, 0, 0, 0, 10, 1587090664);
INSERT INTO `online_log` VALUES (46, 0, 0, 0, 10, 1587090724);
INSERT INTO `online_log` VALUES (47, 0, 0, 0, 10, 1587090784);
INSERT INTO `online_log` VALUES (48, 0, 0, 0, 10, 1587090844);
INSERT INTO `online_log` VALUES (49, 0, 0, 0, 10, 1587090904);
INSERT INTO `online_log` VALUES (50, 0, 0, 0, 10, 1587090964);
INSERT INTO `online_log` VALUES (51, 0, 0, 0, 10, 1587091024);
INSERT INTO `online_log` VALUES (52, 0, 0, 0, 10, 1587091084);
INSERT INTO `online_log` VALUES (53, 0, 0, 0, 10, 1587091144);
INSERT INTO `online_log` VALUES (54, 0, 0, 0, 10, 1587091204);
INSERT INTO `online_log` VALUES (55, 0, 0, 0, 10, 1587091264);
INSERT INTO `online_log` VALUES (56, 0, 0, 0, 10, 1587091324);
INSERT INTO `online_log` VALUES (57, 0, 0, 0, 10, 1587091384);
INSERT INTO `online_log` VALUES (58, 0, 0, 0, 10, 1587091444);
INSERT INTO `online_log` VALUES (59, 0, 0, 0, 10, 1587091504);
INSERT INTO `online_log` VALUES (60, 0, 0, 0, 10, 1587091564);
INSERT INTO `online_log` VALUES (61, 0, 0, 0, 10, 1587091624);
INSERT INTO `online_log` VALUES (62, 0, 0, 0, 10, 1587091684);
INSERT INTO `online_log` VALUES (63, 0, 0, 0, 10, 1587091744);
INSERT INTO `online_log` VALUES (64, 0, 0, 0, 10, 1587091804);
INSERT INTO `online_log` VALUES (65, 0, 0, 0, 10, 1587091864);
INSERT INTO `online_log` VALUES (66, 0, 0, 0, 10, 1587091924);
INSERT INTO `online_log` VALUES (67, 0, 0, 0, 10, 1587091984);
INSERT INTO `online_log` VALUES (68, 0, 0, 0, 10, 1587092044);
INSERT INTO `online_log` VALUES (69, 0, 0, 0, 10, 1587092104);
INSERT INTO `online_log` VALUES (70, 0, 0, 0, 10, 1587092164);
INSERT INTO `online_log` VALUES (71, 0, 0, 0, 10, 1587092224);
INSERT INTO `online_log` VALUES (72, 0, 0, 0, 10, 1587092284);
INSERT INTO `online_log` VALUES (73, 0, 0, 0, 10, 1587092344);
INSERT INTO `online_log` VALUES (74, 0, 0, 0, 11, 1587092404);
INSERT INTO `online_log` VALUES (75, 0, 0, 0, 11, 1587092464);
INSERT INTO `online_log` VALUES (76, 0, 0, 0, 11, 1587092524);
INSERT INTO `online_log` VALUES (77, 0, 0, 0, 11, 1587092584);
INSERT INTO `online_log` VALUES (78, 0, 0, 0, 11, 1587092644);
INSERT INTO `online_log` VALUES (79, 0, 0, 0, 11, 1587092704);
INSERT INTO `online_log` VALUES (80, 0, 0, 0, 11, 1587092764);
INSERT INTO `online_log` VALUES (81, 0, 0, 0, 11, 1587092824);
INSERT INTO `online_log` VALUES (82, 0, 0, 0, 11, 1587092884);
INSERT INTO `online_log` VALUES (83, 0, 0, 0, 11, 1587092944);
INSERT INTO `online_log` VALUES (84, 0, 0, 0, 11, 1587093004);
INSERT INTO `online_log` VALUES (85, 0, 0, 0, 11, 1587093064);
INSERT INTO `online_log` VALUES (86, 0, 0, 0, 11, 1587093124);
INSERT INTO `online_log` VALUES (87, 0, 0, 0, 11, 1587093184);
INSERT INTO `online_log` VALUES (88, 0, 0, 0, 11, 1587093244);
INSERT INTO `online_log` VALUES (89, 0, 0, 0, 11, 1587093304);
INSERT INTO `online_log` VALUES (90, 0, 0, 0, 11, 1587093364);
INSERT INTO `online_log` VALUES (91, 0, 0, 0, 11, 1587093424);
INSERT INTO `online_log` VALUES (92, 0, 0, 0, 11, 1587093484);
INSERT INTO `online_log` VALUES (93, 0, 0, 0, 11, 1587093544);
INSERT INTO `online_log` VALUES (94, 0, 0, 0, 11, 1587093604);
INSERT INTO `online_log` VALUES (95, 0, 0, 0, 11, 1587093664);
INSERT INTO `online_log` VALUES (96, 0, 0, 0, 11, 1587093724);
INSERT INTO `online_log` VALUES (97, 0, 0, 0, 3, 1587152673);
INSERT INTO `online_log` VALUES (98, 0, 0, 0, 3, 1587152733);
INSERT INTO `online_log` VALUES (99, 0, 0, 0, 15, 1587542378);
INSERT INTO `online_log` VALUES (100, 0, 0, 0, 16, 1587542438);
INSERT INTO `online_log` VALUES (101, 0, 0, 0, 16, 1587542498);
INSERT INTO `online_log` VALUES (102, 1, 0, 0, 16, 1587542558);
INSERT INTO `online_log` VALUES (103, 1, 0, 0, 16, 1587542619);
INSERT INTO `online_log` VALUES (104, 1, 0, 0, 16, 1587542679);
INSERT INTO `online_log` VALUES (105, 1, 0, 0, 16, 1587542739);
INSERT INTO `online_log` VALUES (106, 1, 0, 0, 16, 1587542799);
INSERT INTO `online_log` VALUES (107, 1, 0, 0, 16, 1587542859);
INSERT INTO `online_log` VALUES (108, 1, 0, 0, 16, 1587542919);
INSERT INTO `online_log` VALUES (109, 1, 0, 0, 16, 1587542979);
INSERT INTO `online_log` VALUES (110, 1, 0, 0, 16, 1587543039);
INSERT INTO `online_log` VALUES (111, 1, 0, 0, 16, 1587543099);
INSERT INTO `online_log` VALUES (112, 1, 0, 0, 16, 1587543159);
INSERT INTO `online_log` VALUES (113, 1, 0, 0, 16, 1587543219);
INSERT INTO `online_log` VALUES (114, 1, 0, 0, 16, 1587543279);
INSERT INTO `online_log` VALUES (115, 1, 0, 0, 16, 1587543339);
INSERT INTO `online_log` VALUES (116, 1, 0, 0, 16, 1587543399);
INSERT INTO `online_log` VALUES (117, 1, 0, 0, 16, 1587543459);
INSERT INTO `online_log` VALUES (118, 1, 0, 0, 16, 1587543519);
INSERT INTO `online_log` VALUES (119, 1, 0, 0, 16, 1587543579);
INSERT INTO `online_log` VALUES (120, 1, 0, 0, 16, 1587543639);
INSERT INTO `online_log` VALUES (121, 1, 0, 0, 16, 1587543699);
INSERT INTO `online_log` VALUES (122, 0, 0, 0, 16, 1587543882);
INSERT INTO `online_log` VALUES (123, 0, 0, 0, 16, 1587543942);
INSERT INTO `online_log` VALUES (124, 0, 0, 0, 16, 1587544002);
INSERT INTO `online_log` VALUES (125, 0, 0, 0, 16, 1587544062);
INSERT INTO `online_log` VALUES (126, 0, 0, 0, 16, 1587544122);
INSERT INTO `online_log` VALUES (127, 0, 0, 0, 16, 1587544182);
INSERT INTO `online_log` VALUES (128, 1, 0, 0, 16, 1587545679);
INSERT INTO `online_log` VALUES (129, 1, 0, 0, 16, 1587545739);
INSERT INTO `online_log` VALUES (130, 1, 0, 0, 16, 1587545799);
INSERT INTO `online_log` VALUES (131, 1, 0, 0, 16, 1587545859);
INSERT INTO `online_log` VALUES (132, 1, 0, 0, 16, 1587545919);
INSERT INTO `online_log` VALUES (133, 1, 0, 0, 16, 1587545979);
INSERT INTO `online_log` VALUES (134, 1, 0, 0, 17, 1587546039);
INSERT INTO `online_log` VALUES (135, 1, 0, 0, 17, 1587546099);
INSERT INTO `online_log` VALUES (136, 1, 0, 0, 17, 1587546159);
INSERT INTO `online_log` VALUES (137, 1, 0, 0, 17, 1587546219);
INSERT INTO `online_log` VALUES (138, 1, 0, 0, 17, 1587546279);
INSERT INTO `online_log` VALUES (139, 1, 0, 0, 17, 1587546339);
INSERT INTO `online_log` VALUES (140, 1, 0, 0, 17, 1587546399);
INSERT INTO `online_log` VALUES (141, 1, 0, 0, 17, 1587546459);
INSERT INTO `online_log` VALUES (142, 1, 0, 0, 17, 1587546519);
INSERT INTO `online_log` VALUES (143, 1, 0, 0, 17, 1587546579);
INSERT INTO `online_log` VALUES (144, 1, 0, 0, 17, 1587546640);
INSERT INTO `online_log` VALUES (145, 1, 0, 0, 17, 1587546700);
INSERT INTO `online_log` VALUES (146, 1, 0, 0, 17, 1587546760);
INSERT INTO `online_log` VALUES (147, 1, 0, 0, 17, 1587546820);
INSERT INTO `online_log` VALUES (148, 1, 0, 0, 17, 1587546880);
INSERT INTO `online_log` VALUES (149, 1, 0, 0, 17, 1587546940);
INSERT INTO `online_log` VALUES (150, 1, 0, 0, 17, 1587547000);
INSERT INTO `online_log` VALUES (151, 1, 0, 0, 17, 1587547060);
INSERT INTO `online_log` VALUES (152, 1, 0, 0, 17, 1587547120);
INSERT INTO `online_log` VALUES (153, 1, 0, 0, 17, 1587547180);
INSERT INTO `online_log` VALUES (154, 1, 0, 0, 17, 1587547240);
INSERT INTO `online_log` VALUES (155, 1, 0, 0, 17, 1587547300);
INSERT INTO `online_log` VALUES (156, 1, 0, 0, 17, 1587547360);
INSERT INTO `online_log` VALUES (157, 1, 0, 0, 17, 1587547420);
...
CREATE TABLE `quest_data`  (
  ...
  `module` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '模块(validate(module))',
  `function` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '函数(validate(function))',
  `event` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '事件(validate(event))',
...
CREATE TABLE `quest_log`  (
  ...
  INDEX `role_id`(`role_id`) USING BTREE,
  INDEX `time`(`time`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '任务日志表' ROW_FORMAT = Compressed;
...
-- Records of rank
-- ----------------------------
INSERT INTO `rank` VALUES (1, 1, 1, 1, 1, '1', 1, '', '', '', '');
INSERT INTO `rank` VALUES (1, 2, 2, 2, 2, '2', 1, '', '', '', '');
INSERT INTO `rank` VALUES (1, 3, 3, 3, 3, '3', 1, '', '', '', '');
INSERT INTO `rank` VALUES (1, 4, 4, 4, 4, '4', 1, '', '', '', '');
INSERT INTO `rank` VALUES (1, 5, 5, 5, 5, '5', 1, '', '', '', '');
INSERT INTO `rank` VALUES (1, 6, 6, 6, 6, '6', 1, '', '', '', '');
INSERT INTO `rank` VALUES (1, 7, 7, 7, 7, '7', 1, '', '', '', '');
...
CREATE TABLE `recharge`  (
  ...
  `role_id` bigint(20) UNSIGNED NOT NULL DEFAULT 0 COMMENT '玩家ID',
  `role_name` char(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '玩家名称',
  `account` char(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '平台账号ID',
  ...
  INDEX `time`(`time`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '角色充值订单表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of recharge
-- ----------------------------
INSERT INTO `recharge` VALUES (1, 1, 1, 1, 1, '1', '1', 6.00, 0, 0, 1577808000, 0);
INSERT INTO `recharge` VALUES (2, 2, 1, 1, 1, '1', '1', 18.00, 0, 0, 1577894400, 0);
INSERT INTO `recharge` VALUES (3, 3, 1, 1, 1, '1', '1', 68.00, 0, 0, 1577980800, 0);
INSERT INTO `recharge` VALUES (4, 4, 1, 1, 1, '1', '1', 128.00, 0, 0, 1578067200, 0);
INSERT INTO `recharge` VALUES (5, 5, 1, 1, 2, '2', '2', 268.00, 0, 0, 1578153600, 0);
INSERT INTO `recharge` VALUES (6, 6, 1, 1, 2, '2', '2', 588.00, 0, 0, 1577808000, 0);
INSERT INTO `recharge` VALUES (7, 7, 1, 1, 2, '2', '2', 688.00, 0, 0, 1577808000, 0);
INSERT INTO `recharge` VALUES (8, 8, 1, 1, 3, '3', '3', 888.00, 0, 0, 1577894400, 0);
INSERT INTO `recharge` VALUES (9, 9, 1, 1, 3, '3', '3', 1288.00, 0, 0, 1577980800, 0);
INSERT INTO `recharge` VALUES (10, 10, 1, 1, 4, '4', '4', 8888.00, 0, 0, 1577808000, 0);
...
CREATE TABLE `recharge_data`  (
  ...
  `now_price` decimal(10, 2) UNSIGNED NOT NULL COMMENT '现价',
  ...
  `icon` char(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '图片',
  `name` char(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '名字',
  `description` char(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '描述',
  PRIMARY KEY (`recharge_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '充值配置表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of recharge_data
-- ----------------------------
INSERT INTO `recharge_data` VALUES (1, 3, 0, 1, 6.00, 6.00, 6, 0, 1, 9999, 1, '0', '至尊神兵宝箱', '');
INSERT INTO `recharge_data` VALUES (2, 1, 0, 1, 18.00, 18.00, 18, 5, 1, 9999, 2, '1', '元宝', '');
INSERT INTO `recharge_data` VALUES (3, 1, 0, 1, 68.00, 68.00, 68, 40, 1, 9999, 3, '2', '元宝', '');
INSERT INTO `recharge_data` VALUES (4, 1, 0, 1, 128.00, 128.00, 128, 90, 1, 9999, 4, '3', '元宝', '');
INSERT INTO `recharge_data` VALUES (5, 1, 0, 1, 268.00, 268.00, 268, 190, 1, 9999, 5, '4', '元宝', '');
INSERT INTO `recharge_data` VALUES (6, 1, 0, 1, 588.00, 588.00, 588, 330, 1, 9999, 6, '5', '元宝', '');
INSERT INTO `recharge_data` VALUES (7, 1, 0, 1, 688.00, 688.00, 688, 590, 1, 9999, 7, '6', '元宝', '');
INSERT INTO `recharge_data` VALUES (8, 1, 0, 1, 888.00, 888.00, 888, 1300, 1, 9999, 8, '7', '元宝', '');
INSERT INTO `recharge_data` VALUES (9, 2, 0, 1, 1288.00, 1288.00, 1288, 0, 1, 9999, 0, '', '周卡', '');
INSERT INTO `recharge_data` VALUES (10, 6, 0, 1, 8888.00, 8888.00, 8888, 0, 1, 9999, 0, '', '月卡', '');
...
CREATE TABLE `role`  (
  ...
  `device_id` char(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '设备ID',
  `device_type` char(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '设备类型',
  `mac` char(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT 'Mac地址',
  PRIMARY KEY (`role_id`) USING BTREE,
  INDEX `account`(`account`) USING BTREE,
  INDEX `online_time`(`online_time`) USING BTREE,
  INDEX `register_time`(`register_time`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '角色信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of role
-- ----------------------------
INSERT INTO `role` VALUES (1, '1', '1', 3, 100, 1, 1, 100, 100, 100, 0, 1587547500, 1577808000, 1, 1, '{map,1000000000000000,100000,<0.161.0>,city,90,10}', '', '', '');
INSERT INTO `role` VALUES (2, '2', '2', 2, 200, 2, 2, 100, 100, 100, 0, 1577894400, 1577894400, 1, 1, '', '', '', '');
INSERT INTO `role` VALUES (3, '3', '3', 2, 300, 1, 3, 100, 100, 100, 0, 1577980800, 1577980800, 1, 1, '', '', '', '');
INSERT INTO `role` VALUES (4, '4', '4', 1, 400, 2, 4, 100, 100, 100, 0, 1578067200, 1578067200, 1, 1, '', '', '', '');
INSERT INTO `role` VALUES (5, '5', '5', 1, 500, 1, 5, 100, 100, 100, 0, 1578153600, 1578153600, 1, 1, '', '', '', '');
INSERT INTO `role` VALUES (6, '6', '6', 2, 600, 2, 1, 100, 100, 100, 0, 1578240000, 1578240000, 1, 1, '', '', '', '');
INSERT INTO `role` VALUES (7, '7', '7', 3, 700, 2, 3, 100, 100, 100, 0, 1578326400, 1578326400, 1, 1, '', '', '', '');
INSERT INTO `role` VALUES (8, '8', '8', 1, 800, 2, 4, 100, 100, 100, 0, 1578412800, 1578412800, 1, 1, '', '', '', '');
INSERT INTO `role` VALUES (9, '9', '9', 3, 900, 1, 5, 100, 100, 100, 0, 1578499200, 1578499200, 1, 1, '', '', '', '');
INSERT INTO `role` VALUES (10, '10', '10', 2, 1000, 2, 2, 100, 100, 100, 0, 1578585600, 1578585600, 1, 1, '', '', '', '');
...
CREATE TABLE `role_log`  (
  ...
  INDEX `role_id`(`role_id`) USING BTREE,
  INDEX `time`(`time`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '角色日志表' ROW_FORMAT = Compressed;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '角色商店表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '商店配置表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `shop_log`  (
  ...
  INDEX `role_id`(`role_id`) USING BTREE,
  INDEX `time`(`time`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '商店日志表' ROW_FORMAT = Compressed;
...
CREATE TABLE `skill_data`  (
  ...
  `cost` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '升级消耗',
...
CREATE TABLE `title_data`  (
  ...
  `type` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '类型',
  `multi` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '同类型可否拥有多个(validate(boolean))',
  `unique` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '是否全服唯一(validate(boolean))',
  `time` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '有效时间',
  `attribute` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '属性',
  `name` char(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '称号名字',
  `description` char(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '称号描述',
...
CREATE TABLE `title_log`  (
  ...
  INDEX `role_id`(`role_id`) USING BTREE,
  INDEX `time`(`time`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '称号日志表' ROW_FORMAT = Compressed;
