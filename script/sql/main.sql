...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='玩家资产表';
...
INSERT INTO `data_fashion` VALUES (1,1,1),(2,2,2),(3,0,3);
...
INSERT INTO `data_item` VALUES (1,'金币',1,1),(2,'银币',1,1),(3,'铜币',1,1);
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='激活码配置表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='激活码奖励配置表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `data_node` VALUES ('main',1,'','center',1,''),('local',2,'','center',1,''),('test',3,'','center',1,'');
...
INSERT INTO `data_parameter` VALUES ('null','',''),('test','',''),('{guild_create, 1}','[{level, 10}, {vip, 0}, {gold, 0}]','一级'),('{guild_create, 2}','[{level, 10}, {vip, 1}, {gold, 100}]','二级'),('{guild_create, cd}','86400','创建/加入冷却时间'),('{guild_member, limit, 0}','60','人员数');
...
INSERT INTO `data_quest` VALUES (1,1,0,2,'[]','[{quest_progress, event_kill_monster, 3, gt}]','[{1,1}]'),(2,1,1,3,'[{copper, 100}]','[{quest_progress, event_level_upgrade, 10, gt}]','[{1,10}]'),(3,1,2,0,'[{level, 10}]','[{quest_progress, event_dungeon, 5, gt}]','[{1,100}]');
/*!40000 ALTER TABLE `data_quest` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `data_sensitive_word`
--
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='商店配置表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `data_text` VALUES ('1','不用买，随便爆','成龙台词'),('2','是兄弟就来砍我','古天乐台词'),('3','卸载掉手机那个假传奇','甄子丹台词'),('add_item_content','你的益达','背包满内容'),('add_item_title','背包满','背包满标题'),('test','','');
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='玩家时装表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='公会表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `guild` VALUES (1,'1',0,0,0,0,'','','',''),(2,'2',0,0,0,0,'','','','');
...
CREATE TABLE `guild_player` (
  ...
  `player_pid` varchar(0) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '玩家Pid(ignore)',
  `player_sender_pid` varchar(0) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '玩家发送进程Pid(ignore)',
...
INSERT INTO `guild_player` VALUES (1,1,1,0,0,'','','','',''),(2,2,1,0,0,'','','','',''),(0,3,0,0,0,'','','','','');
...
CREATE TABLE `guild_request` (
  ...
  `player_name` varchar(0) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '玩家名(ignore)(`player`.`name`)',
  `player_pid` varchar(0) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '玩家Pid(ignore)',
  `sender_pid` varchar(0) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '玩家发送进程Pid(ignore)',
  `server_id` varchar(0) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '服务器ID(ignore)(`player`.`server_id`)',
  `extra` varchar(0) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '额外(ignore)',
  `flag` varchar(0) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '标识(ignore)(flag)',
  PRIMARY KEY (`player_id`,`guild_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='公会申请表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `guild_request` VALUES (3,1,0,'','','','','',''),(3,2,0,'','','','','',''),(4,1,0,'','','','','',''),(5,2,0,'','','','','','');
...
CREATE TABLE `item` (
  ...
  `flag` varchar(0) NOT NULL DEFAULT '' COMMENT '标识(ignore)(flag)',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `player_id` (`player_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='玩家物品表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `key` (
  ...
  KEY `key` (`key`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='玩家激活码表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `mail` (
  ...
  `sender_nick` varchar(16) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '发送者昵称',
  `receiver_id` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '接收者(select)',
  `receiver_nick` varchar(16) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '接受者昵称',
  ...
  `from` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '来源',
  `title` varchar(1000) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '标题',
  `content` varchar(1000) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '内容',
  `attachment` varchar(1000) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '附件(convert)',
  `flag` varchar(0) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '标识(flag)(ignore)',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='玩家邮件表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `player` (
  ...
  `device` varchar(255) NOT NULL DEFAULT '' COMMENT '设备',
  `device_type` varchar(255) NOT NULL DEFAULT '' COMMENT '设备类型',
  `mac` varchar(255) NOT NULL DEFAULT '' COMMENT 'Mac地址',
  `extra` varchar(0) NOT NULL DEFAULT '' COMMENT '额外(ignore)',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `account` (`account`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='玩家信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `player` VALUES (1,'1','1',1,0,1,100,100,100,'',0,0,'','','',''),(2,'2','2',2,0,2,100,100,100,'',0,0,'','','',''),(3,'3','3',3,0,3,100,100,100,'',0,0,'','','',''),(4,'4','4',4,0,4,100,100,100,'',0,0,'','','',''),(5,'5','5',5,0,5,100,100,100,'',0,0,'','','','');
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='玩家任务表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `rank` (
  ...
  `name` varchar(16) NOT NULL DEFAULT '' COMMENT '名字(string)',
  `other` varchar(100) NOT NULL DEFAULT '' COMMENT '附加数据(0)',
  `flag` varchar(0) NOT NULL DEFAULT '' COMMENT '标识(ignore)(flag)(1)',
  PRIMARY KEY (`type`,`rank`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='玩家排行表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='玩家商店表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `vip` (
  ...
  PRIMARY KEY (`player_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='玩家vip表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-05-11 11:07:15
