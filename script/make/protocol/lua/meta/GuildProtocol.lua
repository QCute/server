return {
    [30101] = {
        ...
        ["read"] = {name = "data", type = "list", comment = "", key = "", explain = {
            {name = "guild", type = "map", comment = "", explain = {
    ...
    [30102] = {
        ...
        ["read"] = {name = "data", type = "list", comment = "", key = "", explain = {
            {name = "guildRole", type = "map", comment = "", explain = {
    ...
    [30103] = {
        ...
        ["read"] = {name = "data", type = "list", comment = "", key = "", explain = {
            {name = "guildApply", type = "map", comment = "", explain = {
    ...
    [30104] = {
        ...
        ["read"] = {name = "guild", type = "map", comment = "", explain = {
            {name = "guildId", type = "u64", comment = "公会ID", explain = {}},
            {name = "guildName", type = "bst", comment = "公会名字", explain = {}},
    ...
    [30105] = {
        ...
        ["read"] = {name = "guildRole", type = "map", comment = "", explain = {
            {name = "roleId", type = "u64", comment = "成员ID", explain = {}},
            {name = "job", type = "u8", comment = "职位", explain = {}},
            {name = "joinTime", type = "u32", comment = "加入时间", explain = {}},
            {name = "roleName", type = "bst", comment = "成员名字", explain = {}},
    ...
    [30108] = {
        ["comment"] = "申请",
        ["write"] = {name = "data", type = "u64", comment = "公会ID", explain = {}},
        ["read"] = {name = "data", type = "rst", comment = "结果", explain = {}}
    },
    [30109] = {
        ["comment"] = "取消申请",
    ...
    [30111] = {
        ["comment"] = "允许申请",
        ["write"] = {name = "data", type = "u64", comment = "角色ID", explain = {}},
        ["read"] = {name = "data", type = "rst", comment = "结果", explain = {}}
    },
    [30112] = {
        ["comment"] = "允许全部申请",
    ...
    [30120] = {
        ["comment"] = "更改公告",
        ["write"] = {name = "data", type = "bst", comment = "公告", explain = {}},
        ["read"] = {name = "data", type = "rst", comment = "结果", explain = {}}
    }
}