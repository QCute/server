...
encode_notice_list_50001(Acc = <<_/binary>>, Length, [#notice_role{notice_id = NoticeId, receive_time = ReceiveTime, read_time = ReadTime, title = Title, content = Content} | NoticeList]) ->
