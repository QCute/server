...
handle(User, 30101, Data) ->
    guild_server:query_guild(User, Data);

handle(User, 30102, Data) ->
    guild_server:query_role(User, Data);

handle(User, 30103, Data) ->
    guild_server:query_apply(User, Data);

handle(User, 30104, Data) ->
    guild_server:query_self_guild(User, Data);

handle(User, 30105, Data) ->
    guild_server:query_self_role(User, Data);

handle(User, 30106, Data) ->
    guild_server:query_self_apply(User, Data);

handle(User, 30107, Data) ->
    guild_server:create(User, Data);
...
handle(User, 30110, Data) ->
    guild_server:cancel_all_apply(User, Data);

handle(User, 30111, Data) ->
    guild_server:approve_apply(User, Data);

handle(User, 30112, Data) ->
    guild_server:approve_all_apply(User, Data);

handle(User, 30113, Data) ->
    guild_server:reject_apply(User, Data);

handle(User, 30114, Data) ->
    guild_server:reject_all_apply(User, Data);

handle(User, 30115, Data) ->
    guild_server:leave(User, Data);

handle(User, 30116, Data) ->
    guild_server:dismiss(User, Data);

handle(User, 30117, Data) ->
    guild_server:kick(User, Data);

handle(User, 30118, Data) ->
    guild_server:update_job(User, Data);

handle(User, 30119, Data) ->
    guild_server:upgrade_level(User, Data);
...
send_query_self_guild(User, Guild) ->
    {ok, Binary} = guild_protocol:encode(30104, Guild),
    User#user{buffer = <<(User#user.buffer)/binary, Binary/binary>>}.

send_query_self_role(User, GuildRole) ->
