...
decode_data_65532(<<_/binary>>, Size, 0, List) ->
    {Size, List};
decode_data_65532(_Rest_ = <<_/binary>>, Size, DataLength, List) ->
    <<Data:32, _DataRest_/binary>> = _Rest_,
    decode_data_65532(_DataRest_, Size + byte_size(_Rest_) - byte_size(_DataRest_), DataLength - 1, [Data | List]).

decode_data_65533(<<_/binary>>, Size, 0, List) ->
    {Size, List};
decode_data_65533(_Rest_ = <<_/binary>>, Size, DataLength, List) ->
    <<Id:64, _IdRest_/binary>> = _Rest_,
    decode_data_65533(_IdRest_, Size + byte_size(_Rest_) - byte_size(_IdRest_), DataLength - 1, [{Id} | List]).

decode_name_ls_65534(<<_/binary>>, Size, 0, List) ->
    {Size, List};
decode_name_ls_65534(_Rest_ = <<_/binary>>, Size, NameLsLength, List) ->
    ...
    decode_name_ls_65534(_NameLsSxRest_, Size + byte_size(_Rest_) - byte_size(_NameLsSxRest_), NameLsLength - 1, [{NameLsIx, NameLsNx, NameLsRx, NameLsSx} | List]).

decode_name_ls_rx_65534(<<_/binary>>, Size, 0, List) ->
    {Size, List};
decode_name_ls_rx_65534(_Rest_ = <<_/binary>>, Size, NameLsRxLength, List) ->
    <<NameLsRxData:32, _NameLsRxDataRest_/binary>> = _Rest_,
    decode_name_ls_rx_65534(_NameLsRxDataRest_, Size + byte_size(_Rest_) - byte_size(_NameLsRxDataRest_), NameLsRxLength - 1, [NameLsRxData | List]).

decode_name_ls_sx_65534(<<_/binary>>, Size, 0, List) ->
    {Size, List};
decode_name_ls_sx_65534(_Rest_ = <<_/binary>>, Size, NameLsSxLength, List) ->
    ...
    decode_name_ls_sx_65534(_NameLsSxNnRest_, Size + byte_size(_Rest_) - byte_size(_NameLsSxNnRest_), NameLsSxLength - 1, [{NameLsSxIi, NameLsSxNn} | List]).

decode_name_lss_65534(<<_/binary>>, Size, 0, List) ->
    {Size, List};
decode_name_lss_65534(_Rest_ = <<_/binary>>, Size, NameLssLength, List) ->
    <<NameLssData:8, _NameLssDataRest_/binary>> = _Rest_,
    decode_name_lss_65534(_NameLssDataRest_, Size + byte_size(_Rest_) - byte_size(_NameLssDataRest_), NameLssLength - 1, [NameLssData | List]).
...
decode_tuple_single_65535(_Rest_ = <<_/binary>>, Size, TupleSingleLength, List) ->
    ...
    decode_tuple_single_65535(_TupleSingleDataRest_, Size + byte_size(_Rest_) - byte_size(_TupleSingleDataRest_), TupleSingleLength - 1, [TupleSingleData | List]).
...
decode_index_list_single_65535(_Rest_ = <<_/binary>>, Size, IndexListSingleLength, List) ->
    ...
    decode_index_list_single_65535(_IndexListSingleDataRest_, Size + byte_size(_Rest_) - byte_size(_IndexListSingleDataRest_), IndexListSingleLength - 1, [IndexListSingleData | List]).
