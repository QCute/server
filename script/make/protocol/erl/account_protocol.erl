...
encode(10000, Result) ->
    Data10000 = <<(protocol:text(Result))/binary>>,
...
encode(10003, Result) ->
    Data10003 = <<(protocol:text(Result))/binary>>,
    {ok, <<(byte_size(Data10003)):16, 10003:16, Data10003/binary>>};

encode(10004, Result) ->
    Data10004 = <<(protocol:text(Result))/binary>>,
...
encode_list_10001(Acc = <<_/binary>>, Length, [{RoleId, RoleName} | List]) ->
    encode_list_10001(<<Acc/binary, RoleId:64, (byte_size(RoleName)):16, (RoleName)/binary>>, Length + 1, List).
