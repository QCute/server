...
public static class WelfareProtocol
{
    public static Map GetMeta()
    {
        return new Map()
        {
            ...
            {"15002", new Map() {
                {"comment", "兑换码兑换"},
                {"write", new Map() { {"name", "data"}, {"type", "bst"}, {"comment", "兑换码"}, {"explain", new List()} }},
                {"read", new Map() { {"name", "data"}, {"type", "ast"}, {"comment", "结果"}, {"explain", new List()} }}
            }},
            {"15003", new Map() {
                {"comment", "红包"},
                {"write", new Map() { {"name", "data"}, {"type", "u64"}, {"comment", "红包编号"}, {"explain", new List()} }},
                {"read", new Map() { {"name", "luckyMoney"}, {"type", "map"}, {"comment", ""}, {"explain", new List() {
                    ...
                    new Map() { {"name", "receiveList"}, {"type", "list"}, {"comment", "领取列表"}, {"explain", new List() {
                        new Map() { {"name", "luckyMoneyRole"}, {"type", "map"}, {"comment", ""}, {"explain", new List() {
