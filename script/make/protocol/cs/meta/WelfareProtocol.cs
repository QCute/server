    ...
    public static Map GetMeta()
    {
        return new Map()
        {
            ...
            {"15002", new Map() {
                {"comment", "兑换码兑换"},
                {"write", new List() {
                    new Map() { {"name", "data"}, {"type", "bst"}, {"comment", "兑换码"}, {"explain", new List()} }
                }},
                {"read", new List() {
                    new Map() { {"name", "data"}, {"type", "rst"}, {"comment", "结果"}, {"explain", new List()} }
                }}
            ...
            {"15003", new Map() {
                {"comment", "红包"},
                {"write", new List() {
                    new Map() { {"name", "data"}, {"type", "u64"}, {"comment", "红包编号"}, {"explain", new List()} }
                }},
                {"read", new List() {
                    new Map() { {"name", "luckyMoney"}, {"type", "record"}, {"comment": ""}, {"explain": new List() {
                        ...
                        new Map() { {"name", "receiveList"}, {"type", "list"}, {"comment", "领取列表"}, {"explain", 
                            new Map() { {"name", "luckyMoneyRole"}, {"type", "record"}, {"comment": ""}, {"explain": new List() {
                                ...
                                new Map() { {"name", "time"}, {"type", "u32"}, {"comment", "领取时间"}, {"explain", new List()} }
                            }}}
                        }},
                        new Map() { {"name", "time"}, {"type", "u32"}, {"comment", "发送时间"}, {"explain", new List()} }
                    }}}
                }}
            }},
            {"15004", new Map() {
