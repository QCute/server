    ...
    public static Map GetMeta()
    {
        return new Map()
        {
            {"20012", new Map() {
                ...
                {"read", new List() {
                    new Map() { {"name", "fighter"}, {"type", "record"}, {"comment": "Fighter"}, {"explain": new List() {
            ...
            {"20014", new Map() {
                ...
                {"write", new List() {
                    ...
                    new Map() { {"name", "targetList"}, {"type", "list"}, {"comment", "对象列表"}, {"explain", 
                    ...
                    new Map() { {"name", "list"}, {"type", "list"}, {"comment", "对象列表"}, {"explain", new List() {
                        new Map() { {"name", "fighter"}, {"type", "record"}, {"comment": "Fighter"}, {"explain": new List() {
                            ...
                            new Map() { {"name", "skill"}, {"type", "list"}, {"comment", "技能列表"}, {"explain", new List() {
                                new Map() { {"name", "battleSkill"}, {"type", "record"}, {"comment": "BattleSkill"}, {"explain": new List() {
                                    new Map() { {"name", "skillId"}, {"type", "u32"}, {"comment", "技能ID"}, {"explain", new List()} },
                            ...
                            new Map() { {"name", "buff"}, {"type", "list"}, {"comment", "Buff列表"}, {"explain", new List() {
                                new Map() { {"name", "battleBuff"}, {"type", "record"}, {"comment": "BattleBuff"}, {"explain": new List() {
