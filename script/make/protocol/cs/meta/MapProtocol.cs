    ...
    public static Map GetMeta()
    {
        return new Map()
        {
            ...
            {"20012", new Map() {
                ...
                {"read", new List() {
                    new Map() { {"name", "fighter"}, {"type", "record"}, {"comment": ""}, {"explain": new List() {
            ...
            {"20014", new Map() {
                ...
                {"write", new List() {
                    new Map() { {"name", "data"}, {"type", "tuple"}, {"comment": ""}, {"explain": new List() {
                        ...
                        new Map() { {"name", "targetList"}, {"type", "list"}, {"comment", "战斗对象ID列表"}, {"explain", 
                            new Map() { {"name", "item"}, {"type", "u64"}, {"comment", "战斗对象ID"}, {"explain", new List()} }
                        }}
                    }}}
                }},
                {"read", new List() {
                    new Map() { {"name", "data"}, {"type", "tuple"}, {"comment": ""}, {"explain": new List() {
                        ...
                        new Map() { {"name", "fighterList"}, {"type", "list"}, {"comment", ""}, {"explain", 
                            new Map() { {"name", "fighter"}, {"type", "record"}, {"comment": ""}, {"explain": new List() {
                                new Map() { {"name", "id"}, {"type", "u64"}, {"comment", "ID"}, {"explain", new List()} },
                                new Map() { {"name", "type"}, {"type", "u8"}, {"comment", "类型"}, {"explain", new List()} },
                                new Map() { {"name", "attribute"}, {"type", "record"}, {"comment": "属性"}, {"explain": new List() {
                                ...
                                new Map() { {"name", "skill"}, {"type", "list"}, {"comment", "技能列表"}, {"explain", 
                                    new Map() { {"name", "battleSkill"}, {"type", "record"}, {"comment": ""}, {"explain": new List() {
                                        new Map() { {"name", "skillId"}, {"type", "u32"}, {"comment", "技能ID"}, {"explain", new List()} },
                                        new Map() { {"name", "time"}, {"type", "u32"}, {"comment", "时间"}, {"explain", new List()} },
                                        new Map() { {"name", "number"}, {"type", "u32"}, {"comment", "数量"}, {"explain", new List()} }
                                    }}}
                                }},
                                new Map() { {"name", "buff"}, {"type", "list"}, {"comment", "Buff列表"}, {"explain", 
                                    new Map() { {"name", "battleBuff"}, {"type", "record"}, {"comment": ""}, {"explain": new List() {
