    ...
    public static Map GetMeta()
    {
        return new Map()
        {
            ...
            {"30108", new Map() {
                {"comment", "申请"},
                {"write", new List() {
                    new Map() { {"name", "data"}, {"type", "u64"}, {"comment", "公会ID"}, {"explain", new List()} }
                }},
                {"read", new List() {
                    new Map() { {"name", "data"}, {"type", "rst"}, {"comment", "结果"}, {"explain", new List()} }
                }}
            ...
            {"30111", new Map() {
                {"comment", "允许申请"},
                {"write", new List() {
                    new Map() { {"name", "data"}, {"type", "u64"}, {"comment", "角色ID"}, {"explain", new List()} }
                }},
                {"read", new List() {
                    new Map() { {"name", "data"}, {"type", "rst"}, {"comment", "结果"}, {"explain", new List()} }
                }}
            ...
            {"30120", new Map() {
                {"comment", "更改公告"},
                {"write", new List() {
                    new Map() { {"name", "data"}, {"type", "bst"}, {"comment", "公告"}, {"explain", new List()} }
                }},
                {"read", new List() {
                    new Map() { {"name", "data"}, {"type", "rst"}, {"comment", "结果"}, {"explain", new List()} }
                }}
