        ...
        return new Map()
        {
            {"65535", new Map() {
                ...
                {"write", new List() {
                    ...
                    new Map() { {"name", "tupleSubListSingle"}, {"type", "list"}, {"comment", "tuple_sub_list_single"}, {"explain", new List() {
                    ...
                    new Map() { {"name", "indexList"}, {"type", "list"}, {"comment", "list"}, {"explain", new List() {
                        ...
                        new Map() { {"name", "listSubListSingle"}, {"type", "list"}, {"comment", "list_sub_list_single"}, {"explain", new List() {
