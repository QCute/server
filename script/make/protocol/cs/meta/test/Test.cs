class Test 
{
    public static void Main(System.String[] args)
    {
        ...
        var buffer = writer.Write((System.UInt16)data["protocol"], (System.Collections.Generic.Dictionary<System.String, System.Object>)data["content"]);
        var reader = new ProtocolReader();
        var result = reader.Read(new System.IO.MemoryStream(buffer));
