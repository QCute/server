    ...
    public static Map GetMeta()
    {
        return new Map()
        {
            {"16101", new Map() {
                ...
                {"read", new Map() { {"name", "data"}, {"type", "list"}, {"comment", "拍品列表"}, {"key", ""}, {"explain", new List() {
                    new Map() { {"name", "data"}, {"type", "map"}, {"comment", "拍品"}, {"explain", new List() {
            ...
            {"16102", new Map() {
                ...
                {"read", new Map() { {"name", "data"}, {"type", "map"}, {"comment", ""}, {"explain", new List() {
                    ...
                    new Map() { {"name", "auction"}, {"type", "map"}, {"comment", "拍品"}, {"explain", new List() {
                        new Map() { {"name", "auctionNo"}, {"type", "u64"}, {"comment", "拍品编号"}, {"explain", new List()} },
                        new Map() { {"name", "auctionId"}, {"type", "u32"}, {"comment", "拍品ID"}, {"explain", new List()} },
                        new Map() { {"name", "type"}, {"type", "u8"}, {"comment", "拍卖类型(1:全服/2:公会)"}, {"explain", new List()} },
                        new Map() { {"name", "endTime"}, {"type", "u32"}, {"comment", "结束时间"}, {"explain", new List()} },
