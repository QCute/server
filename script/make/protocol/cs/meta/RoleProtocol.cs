    ...
    public static Map GetMeta()
    {
        return new Map()
        {
            {"10101", new Map() {
                ...
                {"read", new List() {
                    new Map() { {"name", "role"}, {"type", "record"}, {"comment": ""}, {"explain": new List() {
            ...
            {"10102", new Map() {
                ...
                {"read", new List() {
                    new Map() { {"name", "asset"}, {"type", "record"}, {"comment": ""}, {"explain": new List() {
            ...
            {"10103", new Map() {
                ...
                {"read", new List() {
                    new Map() { {"name", "vip"}, {"type", "record"}, {"comment": ""}, {"explain": new List() {
