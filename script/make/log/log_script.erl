...
log() ->
    [
        ...
        {"src/module/log/log.erl", log, total_online_log},
        {"src/module/log/log_sql_save.erl", save, total_online_log},
        {"src/module/log/log_sql_clean.erl", clean, total_online_log},
        {"src/module/log/log_sql_retain.erl", retain, total_online_log},
        ...
        {"src/module/log/log.erl", log, asset_produce_log},
        {"src/module/log/log_sql_save.erl", save, asset_produce_log},
        {"src/module/log/log_sql_clean.erl", clean, asset_produce_log},
        {"src/module/log/log_sql_retain.erl", retain, asset_produce_log},

        {"src/module/log/log.erl", log, asset_consume_log},
        {"src/module/log/log_sql_save.erl", save, asset_consume_log},
        {"src/module/log/log_sql_clean.erl", clean, asset_consume_log},
        {"src/module/log/log_sql_retain.erl", retain, asset_consume_log},
