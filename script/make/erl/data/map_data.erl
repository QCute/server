...
get(100000) ->
    #map_data{map_id = 100000, type = slice, reconnect = false, monsters = [], rank_key = none, rank_value = hurt, rank_mode = share, enter_points = [], pk_mode = [], enter_script = [], relive_script = [], leave_script = []};
get(110001) ->
