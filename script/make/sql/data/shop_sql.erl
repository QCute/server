...
save(ShopList) ->
    db:save_into(<<"INSERT INTO `shop` (`role_id`, `shop_id`, `number`) VALUES">>, <<"(:1:, :2:, :3:)">>, <<"ON DUPLICATE KEY UPDATE `role_id` = VALUES(`role_id`), `shop_id` = VALUES(`shop_id`), `number` = VALUES(`number`)">>, ShopList, #shop.flag).
