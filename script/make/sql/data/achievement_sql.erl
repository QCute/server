...
save(AchievementList) ->
    db:save_into(<<"INSERT INTO `achievement` (`role_id`, `achievement_id`, `type`) VALUES">>, <<"(:1:, :2:, :3:)">>, <<"ON DUPLICATE KEY UPDATE `role_id` = VALUES(`role_id`), `achievement_id` = VALUES(`achievement_id`), `type` = VALUES(`type`)">>, AchievementList, #achievement.flag).
