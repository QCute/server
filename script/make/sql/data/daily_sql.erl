...
save(DailyList) ->
    db:save_into(<<"INSERT INTO `daily` (`role_id`, `daily_id`, `is_award`) VALUES">>, <<"(:1:, :2:, :3:)">>, <<"ON DUPLICATE KEY UPDATE `role_id` = VALUES(`role_id`), `daily_id` = VALUES(`daily_id`), `is_award` = VALUES(`is_award`)">>, DailyList, #daily.flag).
