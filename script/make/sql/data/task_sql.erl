...
save(TaskList) ->
    db:save_into(<<"INSERT INTO `task` (`role_id`, `task_id`, `type`, `number`, `is_award`) VALUES">>, <<"(:1:, :2:, :3:, :4:, :5:)">>, <<"ON DUPLICATE KEY UPDATE `role_id` = VALUES(`role_id`), `task_id` = VALUES(`task_id`), `type` = VALUES(`type`), `number` = VALUES(`number`), `is_award` = VALUES(`is_award`)">>, TaskList, #task.flag).
