...
save(SkillList) ->
    db:save_into(<<"INSERT INTO `skill` (`role_id`, `skill_id`, `level`) VALUES">>, <<"(:1:, :2:, :3:)">>, <<"ON DUPLICATE KEY UPDATE `role_id` = VALUES(`role_id`), `skill_id` = VALUES(`skill_id`), `level` = VALUES(`level`)">>, SkillList, #skill.flag).
