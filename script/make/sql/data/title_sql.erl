...
save(TitleList) ->
    db:save_into(<<"INSERT INTO `title` (`role_id`, `title_id`, `type`, `expire_time`) VALUES">>, <<"(:1:, :2:, :3:, :4:)">>, <<"ON DUPLICATE KEY UPDATE `role_id` = VALUES(`role_id`), `title_id` = VALUES(`title_id`), `type` = VALUES(`type`), `expire_time` = VALUES(`expire_time`)">>, TitleList, #title.flag).
