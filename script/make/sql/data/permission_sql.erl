...
insert(Permission) ->
    db:insert(<<"INSERT INTO `permission` (`permission_no`, `role_id`, `type`, `status`, `begin_time`, `end_time`, `time`, `reason`, `remark`) VALUES (:1:, :2:, :3:, :4:, :5:, :6:, :7:, :8:, :9:)">>, Permission).

%% @doc insert into permission
-spec save(Permission :: #permission{}) -> InsertIdOrAffectedRows :: non_neg_integer().
save(Permission) ->
    db:insert(<<"INSERT IGNORE INTO `permission` (`permission_no`, `role_id`, `type`, `status`, `begin_time`, `end_time`, `time`, `reason`, `remark`) VALUES (:1:, :2:, :3:, :4:, :5:, :6:, :7:, :8:, :9:)">>, Permission).
