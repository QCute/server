...
%% Flags for 'erl'        : +hpds 2 -hidden +pc unicode -pa beam -pa config -pa app -smp true +P 10485760 +t 10485760 +zdbbl 1024 -setcookie erlang -name main@127.0.0.1 -config config/main -boot start_sasl
