...
write(11001, [#role{id = Id, sex = Sex, level = Level, classes = Classes, item_size = ItemSize, bag_size = BagSize, store_size = StoreSize}]) ->
    RoleBinary = <<Id:64, Sex:8, Level:64, Classes:8, ItemSize:16, BagSize:16, StoreSize:16>>,
    {ok, protocol:pack(11001, <<RoleBinary/binary>>)};
