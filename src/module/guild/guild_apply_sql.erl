...
save(GuildApplyList) ->
    db:save_into(<<"INSERT INTO `guild_apply` (`guild_id`, `role_id`, `apply_time`) VALUES">>, <<"(:1:, :2:, :3:)">>, <<"ON DUPLICATE KEY UPDATE `guild_id` = VALUES(`guild_id`), `role_id` = VALUES(`role_id`), `apply_time` = VALUES(`apply_time`)">>, GuildApplyList, #guild_apply.flag).
