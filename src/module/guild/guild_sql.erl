...
-compile(export_all).
-include("guild.hrl").
-define(INSERT_GUILD, <<"INSERT INTO `guild` (`exp`, `wealth`, `level`, `create_time`, `guild_name`, `notice`, `leader_id`) VALUES (~i~i~w, ~w, ~w, ~w, '~s', '~s', ~w~i~i~i~i~i~i)">>).
