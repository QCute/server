...
insert(Chat) ->
    db:insert(<<"INSERT INTO `chat` (`role_id`, `world_chat_time`, `guild_chat_time`, `scene_chat_time`, `private_chat_time`) VALUES (:1:, :2:, :3:, :4:, :5:)">>, Chat).
...
update(Chat) ->
    db:update(<<"UPDATE `chat` SET `role_id` = :1:, `world_chat_time` = :2:, `guild_chat_time` = :3:, `scene_chat_time` = :4:, `private_chat_time` = :5: WHERE `role_id` = :1:">>, Chat).
