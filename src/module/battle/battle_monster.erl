...
perform_skill_loop(State = #map_state{fighters = Fighters}, Attacker = #fighter{id = Id}, Skill = #battle_skill{distance = Distance}, [#hatred{id = TargetId} | TargetList], Now, Hurt, List) ->
