...
-define(SELECT_AUCTION, <<"SELECT `auction_no`, `auction_id`, `number`, `type`, `bid_type`, `start_time`, `end_time`, `from`, `bid_number`, `now_price`, `next_price`, `seller_list`, `bidder_list`, `guild_id`, `timer`, 0 AS `flag` FROM `auction`">>).
