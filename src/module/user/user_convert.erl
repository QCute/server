...
to(#user{role_id = RoleId, pid = Pid, sender_pid = SenderPid, receiver_pid = ReceiverPid}, online) ->
    #online{role_id = RoleId, pid = Pid, sender_pid = SenderPid, receiver_pid = ReceiverPid, state = online};
to(#user{role_id = RoleId, pid = Pid}, hosting) ->
    #online{role_id = RoleId, pid = Pid, sender_pid = undefined, receiver_pid = undefined, state = hosting};
