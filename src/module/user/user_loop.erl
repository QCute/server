...
loop(User, Tick, Before, Now) ->
    ...
    CleanUser = case time:is_cross_day(Before, 5, Now) of
        true ->
            ...
            user_event:trigger(User, #event{name = clean});
        false ->
            ResetUser
    end,
    TwoTickUser = case Tick rem 2 == 0 of
        true ->
            ...
            user_event:trigger(User, #event{name = expire});
        false ->
            CleanUser
    end,
    FourTickUser = case Tick rem 4 == 0 of
        true ->
            ...
            user_event:trigger(User, #event{name = save, target = 4});
        false ->
            TwoTickUser
    end,
    SixTickUser = case Tick rem 6 == 0 of
        true ->
            ...
            user_event:trigger(User, #event{name = save, target = 6});
        false ->
            FourTickUser
    end,
    EightTickUser = case Tick rem 8 == 0 of
        true ->
            ...
            user_event:trigger(User, #event{name = save, target = 8});
        false ->
            SixTickUser
    end,
    case Tick rem 10 == 0 of
        true ->
            ...
            user_event:trigger(User, #event{name = save, target = 10});
        false ->
            EightTickUser
    end.
