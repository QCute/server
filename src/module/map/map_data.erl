...
get(100001) ->
    #map_data{map_id = 100001, type = full, reconnect = false, monsters = [1], rank_key = guild, rank_value = hurt, rank_mode = share, enter_points = [], pk_mode = [], enter_script = [], relive_script = [], leave_script = []};
get(100002) ->
    #map_data{map_id = 100002, type = full, reconnect = false, monsters = [2], rank_key = team, rank_value = hurt, rank_mode = share, enter_points = [], pk_mode = [], enter_script = [], relive_script = [], leave_script = []};
get(100003) ->
