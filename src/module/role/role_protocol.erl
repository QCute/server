...
encode(10101, #role{role_id = RoleId, role_name = RoleName, sex = Sex, classes = Classes, level = Level, item_size = ItemSize, bag_size = BagSize, store_size = StoreSize}) ->
    Data10101 = <<RoleId:64, (byte_size(RoleName)):16, (RoleName)/binary, Sex:8, Classes:8, Level:64, ItemSize:16, BagSize:16, StoreSize:16>>,
